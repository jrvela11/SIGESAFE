...
return [
    ...
    'routes' => [
        [
            'match' => [
                // 🟢 PERFECTO: Esto captura automáticamente /api/sales, /api/products, etc.
                'prefixes' => ['api/*'],

                'domains' => ['*'],
            ],

            // Incluir rutas específicas si estuvieran fuera del prefijo (no es tu caso)
            'include' => [
                // Puedes dejarlo vacío
            ],

            // 🚀 EXCLUSIONES ESTRATÉGICAS: Limpiamos ruido de la documentación
            'exclude' => [
                'api/user', // ❌ Excluimos la ruta de prueba de Sanctum para que no ensucie tus docs
                'api/sales/*.update', // ❌ Aseguramos que no intente documentar el UPDATE de ventas que no existe
            ],
        ],
    ],
